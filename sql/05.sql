...
-- Header: 23 + 2 (12 null bitmaps) = 25 + 7 (padding) = 32 
-- Data: 4 + 4 (padding alignment) + 8 + 0 + 0 + 0 + 16 + 0 + 0 + 4 + 2 + 2 (padding alignment) + 8 + 8 = 56
-- Padding: 88 (header + data) + 0 (padding) = 88 
-- Total: 88
